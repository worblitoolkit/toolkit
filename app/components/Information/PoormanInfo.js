...
const PoormanInfo = () => {
  return (
    <div>
      <h5>The POORMANTOKEN is an WBI token that includes signups and burning to make airdrops cheaper</h5>
      <p>The intention is to allow WBI accounts to Airgrab the token (i.e. opt-in or signup)</p>
      ...
      <p>Accounts that meet this criteria will receive POOR 1:1 to STAKED WBI only!</p>
      <p>What can you do with all this POOR? Details coming soon!</p>
      <p>
        To read more about this token contract check out the{' '}
        <a href="https://github.com/generWBI/poorman.token" target="new">
